  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        >
        <p @click="changeDefaultAddress(addressInfo, addressInfoList)">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="(detailInfo, index) in tradeInfo.detailArrayList"
...
export default {
  ...
  methods: {
    //改变默认地址
    changeDefaultAddress(addressInfo, addressInfoList) {
